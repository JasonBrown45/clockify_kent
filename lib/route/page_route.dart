...
import '../activity/presentation/detail_page.dart';
...
Route createActivityBarPageRoute(User selectUser) {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => ActivityBar(
      activeUser: selectUser,
    ),
    transitionsBuilder: (context, animation, secondaryAnimation, child) {
      const begin = Offset(0.0, 1.0);
